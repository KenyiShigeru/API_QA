...
class ProductoModel {
    ...
    insertarProducto(producto) {
        return new Promise((resolve, reject) => {
            this.connection.query('INSERT INTO Producto (id_clasificacion, id_subclasificacion, id_tpMaterial, id_unidad, apl_inst, precio1_sin_s, precio2_con_s, precio3_sin_c, precio4_con_c, observaciones) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [
